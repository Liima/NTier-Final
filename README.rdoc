...
I want to create an account
	I want my account to register an ##alias

I want to destroy my account
I want to log in
I want to log out
I want to post a micropost
	I want to make a post anonymously by default or post under an alias with user##alias
...
I want to call out a user by his username with @username in micropost
...
I want to subscribe to @usernames and #hashtags
	I want a feed loads posts by my subscriptions
